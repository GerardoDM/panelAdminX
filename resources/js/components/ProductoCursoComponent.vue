<template>
   <div class="container">
      ...
      <hr>
      <h2 class="mb-2">Producto-Curso</h2>
      <div class="container; mt-2" style="height:450px; width:max; overflow-y: scroll">
         <hr>
         <table class="table table-hover table-dark">
            <thead>
               <tr>
                  <th style="position:sticky; top:0; background: #000000">
                     Nombre Producto 
                     <font-awesome-icon icon="angle-down" @click="sortBy('nombreCurso')"/>
                  </th>
                  <th style="position:sticky; top:0; background: #000000">
                     Nombre Curso 
                     <font-awesome-icon icon="angle-down" @click="sortBy('nombreProducto')"/>
                  </th>
            ...
            <tbody>
               <tr v-for="pivote in sortedPivotes" v-bind:key="pivote.key">
                  <td>
                     <router-link :to="{ name: 'productoCursoDetalle', params: { clave: pivote.cve_curso, claveDos: pivote.cve_producto }  }" style="color:white">{{pivote.nombreProducto}}</router-link>
                  </td>
                  <td>
                     <router-link :to="{ name: 'productoCursoDetalle', params: { clave: pivote.cve_curso, claveDos: pivote.cve_producto }  }" style="color:white">{{pivote.nombreCurso}}</router-link>
                  </td>
                  <td>
