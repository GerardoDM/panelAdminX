<template>
  <div class="container">
    ...
    <hr>
    <h2 class="mb-2">Productos-Proyectos</h2>
      ...
      <table class="table table-hover table-dark" >
        <thead>
          <tr>
            <th style="position:sticky; top:0; background: #000000">
              Nombre Producto  
              <font-awesome-icon icon="angle-down" @click="sortBy('prodNombre')"/>
            </th>
            <th style="position:sticky; top:0; background: #000000">
              Nombre Proyecto  
              <font-awesome-icon icon="angle-down" @click="sortBy('proyNombre')"/>
            </th>
            <th style="position:sticky; top:0; background: #000000">
              # de Licencias  
              <font-awesome-icon icon="angle-down" @click="sortBy('nolicencias')"/>
            </th>
        ...
        <tbody>
          <tr v-for="pivot in sortedPivot" v-bind:key="pivot.clave">
            <td>
              <router-link :to="{ name: 'pivotDetalle', params: { clave: pivot.clave }  }" style="color:white">{{pivot.prodNombre}}</router-link>
            </td>
            <td>
              <router-link :to="{ name: 'pivotDetalle', params: { clave: pivot.clave }  }" style="color:white">{{pivot.proyNombre}}</router-link>
            </td>
