  ...
  <div class="container">
    ...
    <div class="form-inline">
      ...
      <button class="btn btn-success my-2 my-sm-0" type="button">
        <font-awesome-icon icon="search" @click="searchit()"/>
      </button>
      ...
      <table class="table table-hover table-dark">
        <thead>
          <tr>
            ...
            <th style="position:sticky; top:0; background: #000000">
              Clave Curso  
              <font-awesome-icon icon="angle-down" @click="sortBy('cve_curso')"/>
            </th>
            <th style="position:sticky; top:0; background: #000000">
              Versión  
              <font-awesome-icon icon="angle-down" @click="sortBy('version')"/>
            </th>
            <th style="position:sticky; top:0; background: #000000">
              Ruta Portal  
              <font-awesome-icon icon="angle-down" @click="sortBy('ruta_portal')"/>
            </th>
        ...
        <tbody>
          <tr v-for="bloque in sortedBloques" v-bind:key="bloque.clave">
            <td>
              <router-link :to="{ name: 'bloqueDetalle', params: { clave: bloque.clave }  }" style="color:white">{{bloque.nombre}}</router-link>
            </td>
